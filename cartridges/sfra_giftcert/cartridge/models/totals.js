...
function totals(lineItemContainer) {
    if (lineItemContainer) {
        ...
        if (this.totalShippingCost === '-') {
            //this used to just be a '-' but we'd like to show a subtotal so use getAdjustedMerchandizeTotalPrice which should include discounts
            this.grandTotal = this.subTotal;
        } else if (this.totalTax === '-') {
            //if we have shpping but no tax use totalNetPrice
