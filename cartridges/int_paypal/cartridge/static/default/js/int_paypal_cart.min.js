...
function injectPaypalSDK() {
  ...
  script.onload = function () {
    $isBAEnabled ? Object(_registered_initBillingAgreementButton__WEBPACK_IMPORTED_MODULE_1__["default"])() : Object(_initCartButton__WEBPACK_IMPORTED_MODULE_0__["default"])();
  };
...
if ($paypalImage) {
  ...
  window.paypal ? $isBAEnabled ? Object(_registered_initBillingAgreementButton__WEBPACK_IMPORTED_MODULE_1__["default"])() : Object(_initCartButton__WEBPACK_IMPORTED_MODULE_0__["default"])() : injectPaypalSDK();
}
  ...
  $.ajax({
    ...
    error: function error() {
      ...
      if (!document.querySelector('.cartError')) {
        Object(_api__WEBPACK_IMPORTED_MODULE_0__["showCartErrorHtml"])('An internal server error has occurred. \r\nRetry the request later.');
      }
    }
  });
}
...
function initPaypalButton() {
  ...
  window.paypal.Buttons({
    ...
    onCancel: onCancel,
    onError: onError,
    style: Object(_helper__WEBPACK_IMPORTED_MODULE_1__["getPaypalButtonStyle"])(document.querySelector('.js_paypal_button_on_cart_page'))
...
function onApprove(_ref) {
  ...
  return Object(_api__WEBPACK_IMPORTED_MODULE_0__["createBillingAgreementCall"])(billingToken).then(function (_ref2) {
    ...
    Object(_api__WEBPACK_IMPORTED_MODULE_0__["showCartErrorHtml"])(err.responseText);
  });
}
/**
 * Hides loader on paypal widget closing without errors
