...
var run = function run() {
    ...
    var catalogPathContext = false;
    if(!empty(args.CatalogPathContext) && args.CatalogPathContext) {
        catalogPathContext = true;
    }
    ...
    // Un-compress files
    if (!FileHelper.unzipFiles(fileList, targetFolder, useArchiveNameAsFolder, removeArchivesAfterCompletion, catalogPathContext)) {
