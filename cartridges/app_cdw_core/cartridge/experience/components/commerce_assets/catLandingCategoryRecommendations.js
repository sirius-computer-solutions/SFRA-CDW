...
module.exports.render = function (context, modelIn) {
    ...
    var categories = new Categories(categoriesToBeDisplayed, true);
    ...
    return new Template('experience/components/commerce_assets/catLandingCategoryRecommendations').render(model).text;
};
