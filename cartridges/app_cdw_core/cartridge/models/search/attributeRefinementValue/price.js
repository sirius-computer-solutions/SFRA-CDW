 ...
 */
function PriceAttributeValue(productSearch, refinementDefinition, refinementValue, oci) {
    this.oci = oci;
 ...
 * @param {dw.catalog.ProductSearchRefinementValue} refinementValue - Raw DW refinement value
 */
function PriceRefinementValueWrapper(productSearch, refinementDefinition, refinementValue, httpParams, oci) {
