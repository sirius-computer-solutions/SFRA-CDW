...
/**
 * Retrieves the B2B account details from S2K.
 * @param {accountNumber} the B2B account number 
 * @param {zipCode} the B2B account zip code
 * @return {Object} returns an error object
 */
 function Handle(accountNumber, zipCode) {
    var serverErrors = [];
     var error = false;
    ...
    try {
        ...
        var data = { path : s2kConstants.CHECK_EXISTING_ACCOUNT_API_ACTION, 
