...
function processForm(req, paymentForm, viewFormData) {
    ...
    if (!req.form.storedPaymentUUID) {
        ...
        // if(creditCardErrors.dwfrm_billing_contactInfoFields_email) {
        //     //Removing it as we removed the email out of billing form
        //     delete creditCardErrors.dwfrm_billing_contactInfoFields_email;
        // }
    }
    ...
    if(!empty(req.form.webReferenceNumber)) {
    ...
    if (viewData.storedPaymentUUID
        ...
        Logger.debug('paymentInstrument.creditCardNumber::'+paymentInstrument.creditCardNumber);
        ...
        session.forms.billing.creditCardFields.securityCode.value = req.form.securityCode;
