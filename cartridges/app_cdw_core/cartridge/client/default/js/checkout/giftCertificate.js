var base = require('gift_cert/checkout/giftCertificate');

base.submitGiftCertCode = function() {
    $('.giftcertcode-button').click(function (e) {
        ...
        if (!$('.giftcert-input-field').val()) {
            $('.coupon-missing-error').empty().show().append('Please enter a Gift Card number.');
            $.spinner().stop();
            return false;
        }
...
base.removeGiftCertCode = function() {
...
base.validateGCSelection = function () {
