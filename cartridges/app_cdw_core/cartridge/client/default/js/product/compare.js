...
var compare = require('product_compare/product/compare');
...
function updateSubmitUrl() {
    ...
    if (form.find('[name="backUrl"]').length) {
        form.find('[name="backUrl"]').val(window.location);
    }
}
...
/**
 * Clears the compareBar
 */
function handleClearCompareBar() {
    clearCompareBar();
}
 ...
 */
function deselectProductOnCompareBar() {
 ...
 */
function selectCheckedProducts() {
...
var exportDetails = $.extend(compare, {handleClearCompareBar: handleClearCompareBar});
compare.handleCompareClick = handleCompareClick;
compare.handleClearAll = handleClearAll;
compare.handleClearCompareBar = handleClearCompareBar;
compare.deselectProductOnCompareBar = deselectProductOnCompareBar;
compare.selectCheckedProducts = selectCheckedProducts;
compare.setPushState = setPushState;
compare.catchFilterChange = catchFilterChange;
compare.listenToFilterChange = listenToFilterChange;
