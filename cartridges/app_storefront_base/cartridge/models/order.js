...
function getFirstProductLineItem(productLineItemsModel) {
    if (productLineItemsModel && productLineItemsModel.items[0]) {
        ...
        return {
            imageURL: firstItemImage && firstItemImage.url?firstItemImage.url:"",
            alt: firstItemImage && firstItemImage.alt?firstItemImage.alt:"",
            title: firstItemImage && firstItemImage.title?firstItemImage.title:""
        };
    }
    return null;
}
