...
function updateCartTotals(data) {
    ...
    data.items.forEach(function (item) {
        ...
        if(item.isB2BPrice)
        {
            ...
            $('.line-item-price-' + item.UUID).empty().append('<p class="line-item-price-info">Each</p><div class="unit-price"><div class="price"><span class="sales">'+item.price.sales.formatted +'</span></div></div></div>');
            $('.uuid-' + item.UUID + ' .unit-price').empty().append('<div class="unit-price"><div class="price"><span class="sales">'+item.price.sales.formatted +'</span></div></div></div>');
