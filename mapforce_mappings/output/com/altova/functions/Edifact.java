	...
	*/
	...
	private static DateTime toTime( String sValue, String sFormat, boolean bRaiseExc ) {
		...
		switch (Integer.parseInt(sFormat)) {
			...
			default: {
				if (bRaiseExc)
					throw new com.altova.AltovaException ("Unknown format code. Cannot convert the value '" + sValue + "' using the format code '" + sFormat + "'." );
			}
	...
	private static DateTime toDate( String sValue, String sFormat, boolean bRaiseExc ) {
		...
		switch (Integer.parseInt(sFormat)) {
			...
			case 6: {
				...
				if (B == 2)
					date = Lang.datetimeAdd( date, offset );
				result = date;
			}
			break;
