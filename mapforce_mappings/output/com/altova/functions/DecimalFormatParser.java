...
public class DecimalFormatParser {
	...
	public class DecimalFormat {
		...
		public void SetDecimalSeparator( char cDecimalSeparator ) { mcDecimalSeparator = cDecimalSeparator; }

		public char GetGroupingSeparator() {	return mcGroupingSeparator; }
		public void SetGroupingSeparator( char cGroupingSeparator ) { mcGroupingSeparator = cGroupingSeparator; }

		public String GetInfinity() { return msInfinity; }
		public void SetInfinity( String sInfinity ) { msInfinity = sInfinity; }

		public char GetMinusSign() { return mcMinusSign; }
		public void SetMinusSign( char cMinusSign ) { mcMinusSign = cMinusSign; }
		...
		public void SetPatternSeparator( char cPatternSeparator ) { mcPatternSeparator = cPatternSeparator; }
	...
	public String formatNumber ( BigDecimal nNumber ) {
		...
		if (iDecimalPos <= 0) {
			...
			for (int i = 0; i < iAbsDecimalPos; i++)
				sbRight.append('0');
		...
		if (iRightLen < mFormat.mnZeroDigitsFraction)
			for (int i = 0; i < mFormat.mnZeroDigitsFraction - iRightLen; i++)
				sbRight.append('0');
