...
public class acmeFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel jacmejson_22Label4 = new JLabel();
	JTextField jacmejson_22TextField4 = new JTextField();

	JLabel jcatalog4Label5 = new JLabel();
	JTextField jcatalog4TextField5 = new JTextField();

	JLabel jacmejson_23Label6 = new JLabel();
	JTextField jacmejson_23TextField6 = new JTextField();
	...
	private void jbInit() throws Exception {
		...
		jIconLabel.setIcon(new ImageIcon(acmeFrame.class.getResource("mapforce.png")));
		jIconLabel.setText("");
		...
		jStartButton.addActionListener(new acmeFrame_jStartButton_actionAdapter(this));
	...
	protected void fillScrollPane() {
		...
		jcatalog4TextField5.setText("../FinalACME/catalog.xml");
	...
	void jStartButton_actionPerformed(ActionEvent e) {
		...
		try {
			...
			com.altova.io.Input acmejson_22Source = com.altova.io.StreamInput.createInput("product-feed 7.json");
			com.altova.io.Output catalog4Target = new com.altova.io.FileOutput("../FinalACME/catalog.xml");
		...
		try {
			...
			com.altova.io.Input acmejson_23Source = com.altova.io.StreamInput.createInput("product-feed 7.json");
...
class acmeFrame_jStartButton_actionAdapter
	implements java.awt.event.ActionListener {
	acmeFrame adaptee;

	acmeFrame_jStartButton_actionAdapter(acmeFrame adaptee) {
